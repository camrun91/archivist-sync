 ...
 */
export class AskChatMenu extends foundry.applications.api.HandlebarsApplicationMixin(foundry.applications.api.ApplicationV2) {
    ...
    _onRender(context, options) {
        try {
            ...
            try { registerArchivistSidebarTab(document.getElementById('sidebar')); } catch (_) { /* no-op */ }
