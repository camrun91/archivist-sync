  ...
  rules: [
    {
      ...
      fields: {
        title: '$.name',
        description: [
          '$.metadata.system.details.biography.value',
          '$.metadata.system.details.biography',
          '$.body',
        ],
        portraitUrl: '$.images',
      },
    ...
    },
    {
      ...
      fields: {
        name: '$.name',
        description: [
          '$.metadata.system.description.value',
  ...
  rules: [
    // PF2e hazard actors should not become Character; map them to Note by default
    {
      ...
      fields: {
        title: '$.name',
        content: [
          '$.metadata.system.details.publicNotes',
          '$.metadata.system.details.privateNotes',
          '$.body',
        ],
      },
      labels: ['Hazard'],
